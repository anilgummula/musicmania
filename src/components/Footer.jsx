          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="mt-8 border-t border-gray-600 pt-8 w-full flex flex-col items-center">
              ...
              <p className="text-sm mb-2">
                &copy; 2024 <span className="text-gray-400 font-semibold">Music<span className='text-blue-400'>Mania</span></span> . All rights reserved.
              </p>
              <p className="text-sm">
                Made With ❤️ by <span className="text-gray-400 font-semibold">DEVIL<span className='text-blue-400'>2050</span></span>
              </p>
            </div>
          </div>
        </div>
